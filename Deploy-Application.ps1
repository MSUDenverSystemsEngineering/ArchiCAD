...
Try {
	...
	[string]$appScriptDate = '09/26/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Remove-MSIApplications -Name "ARCHICAD"
		...
		$exitCode = Execute-Process -Path "AC21 USA 3005.exe" -Parameters "/silent" -WindowStyle "Hidden" -PassThru
		...
		[scriptblock]$HKCURegistrySettings = {
		  Set-RegistryKey -Key 'HKCU\Software\GRAPHISOFT\ARCHICAD-64\ARCHICAD-64 21.0.0 USA R1' -Name 'CustomerInvolvementChecked' -Value 1 -Type DWord -SID $UserProfile.SID
			Set-RegistryKey -Key 'HKCU\Software\GRAPHISOFT\ARCHICAD-64\ARCHICAD-64 21.0.0 USA R1' -Name 'UsageLogger' -Value 0 -Type DWord -SID $UserProfile.SID
		}
		Invoke-HKCURegistrySettingsForAllUsers -RegistrySettings $HKCURegistrySettings

		$exitCode = Execute-Process -Path "$envSystem32Directory\netsh.exe" -Parameters "advfirewall firewall add rule name=`"ARCHICAD`" dir=in action=allow program=`"${envProgramFiles}\GRAPHISOFT\ARCHICAD 21\ARCHICAD.exe`" enable=yes" -Windows "Hidden" -WaitForMsiExec -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'archicad' -CloseAppsCountdown 60
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCtte52+rDPFC+2
# fom2CE/gwj60zXczuPAiWgyLDW1I86CCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIIEn
# jI1VJgLuy59PL/rV6y5gaTwt8wlfGh262Z0eMfGvMA0GCSqGSIb3DQEBAQUABIIB
# ADJXL7/ejqh2Wfr3V+piy7mNCFoQpn3zGHhY1Iav8UGj5qo2lCG16qyEcibIejTB
# SbNUNeFaxGfPMD5dTAljE6JGdBCd18UhGwe4LEBPakYXahM4zbctWtWKsYLLzqIg
# Y1MSPq544uvdq12WvGpuJxfA7whBqLI1zC2fNxqLx4NQODwAq9x7KOkmQCXey7sW
# z1JILNa67ieEEFI6dwMlZpE43owM2Oj76nwEEyYRtcsKhxbPQ8XNjtpXQxdBPSD9
# 0MXvXcMC+iZW/tfJKtvjJRqgOdq5c/lbqtDegOJXUsis/5LOuwoM9yLhHg5l04Oi
# 1x3EHpkxwq0FDf67qVUydcyhggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTcwOTI2MTczMjI4WjAjBgkqhkiG9w0BCQQxFgQU
# iwwahyVVfCFFr2gfgu86/htVIHMwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBABtJcztzbni/szMTa/1qKuoFOmmaghJkaa3RNcjUayvEUNV8cmVM27EN
# nNSLBGS3VYFDuX8wchqZGiKrd0t7hGAkh5gn4n9Qd0lVzz1I/SVf9i0jFLg1gzEr
# 5jb5G+/xyvRVyeiEQ7TaqkNpHpk6cM4PsBRYm47iGwparu3A0n+GhsIyxnuZyigx
# 6WIYOHmxbmqCZikCMrz2vf+nnNGIWEQsrN1Ci7gSqPoFGXSNQiCTL1lLyTEoZnbE
# /KAG6loS5Sa5+25i3c9Nls6MLMMq0Qv3fDWoM2W/rTx583asrZ2+VH6JvDkJ1Fup
# U2k1tVUmOpv15hxmyatUz06RlVnVhJA=
